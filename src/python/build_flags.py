...
if '-DRADIO_SX127X=1' in build_flags or '-DRADIO_SX126X=1' in build_flags:
    ...
    if fnmatch.filter(build_flags, '*-DRegulatory_Domain_ISM_2400') or \
        ...
        print_error('Regulatory_Domain_*_2400 not compatible with RADIO_SX127X RADIO_SX126X')
...
if '-DRADIO_SX127X=1' in build_flags or '-DRADIO_LR1121=1' in build_flags or '-DRADIO_SX126X=1' in build_flags:
