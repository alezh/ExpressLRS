...
#define FREQ_STEP ((double)(SX126x_XTAL_FREQ / pow(2.0, 25.0)))  // 198.3642578125   2, 18 33554432 0.95367431640625
...
typedef enum RadioCommands_u
{
    ...
    SX126X_RADIO_SET_CALIBRATE_IMAGE = 0x98,
    SX126X_RADIO_SET_RX_TX_FALLBACK_MODE = 0x93,
    SX126X_RADIO_SET_PA_CONFIG = 0x95,
    ...
    SX126X_RADIO_SET_LORA_SYMB_NUM_TIMEOUT = 0x0A,
    SX126X_RADIO_CLEAR_DEVICE_ERRORS = 0x07,
