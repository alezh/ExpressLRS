...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
   {0, RADIO_TYPE_SX127x_LORA, RATE_LORA_250HZ,     SX126x_LORA_BW_500, SX126x_LORA_SF5, SX126x_LORA_CR_4_7,  8, TLM_RATIO_1_64, 4,  4000, OTA4_PACKET_SIZE, 1},
   {1, RADIO_TYPE_SX127x_LORA, RATE_LORA_200HZ,     SX126x_LORA_BW_500, SX126x_LORA_SF6, SX126x_LORA_CR_4_7,  8, TLM_RATIO_1_64, 4,  5000, OTA4_PACKET_SIZE, 1},
   {2, RADIO_TYPE_SX127x_LORA, RATE_LORA_100HZ_8CH, SX126x_LORA_BW_500, SX126x_LORA_SF6, SX126x_LORA_CR_4_8,  8, TLM_RATIO_1_32, 4, 10000, OTA8_PACKET_SIZE, 1},
   {3, RADIO_TYPE_SX127x_LORA, RATE_LORA_100HZ,     SX126x_LORA_BW_500, SX126x_LORA_SF7, SX126x_LORA_CR_4_7,  8, TLM_RATIO_1_32, 4, 10000, OTA4_PACKET_SIZE, 1},
   {4, RADIO_TYPE_SX127x_LORA, RATE_LORA_50HZ,      SX126x_LORA_BW_500, SX126x_LORA_SF8, SX126x_LORA_CR_4_7, 10, TLM_RATIO_1_16, 4, 20000, OTA4_PACKET_SIZE, 1},
   {5, RADIO_TYPE_SX127x_LORA, RATE_LORA_25HZ,      SX126x_LORA_BW_500, SX126x_LORA_SF9, SX126x_LORA_CR_4_7, 10, TLM_RATIO_1_8,  2, 40000, OTA4_PACKET_SIZE, 1}};

expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
   {0, RATE_LORA_250HZ,     -111,  3216, 3000, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)},
   {1, RATE_LORA_200HZ,     -112,  4380, 3000, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)},// TODO - SNR thresholds need to be checked.
   {2, RATE_LORA_100HZ_8CH, -112,  6690, 3500, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)},
   {3, RATE_LORA_100HZ,     -117,  8770, 3500, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(2.5)},
   {4, RATE_LORA_50HZ,      -120, 18560, 4000, 2500, 600, 5000, SNR_SCALE(-1), SNR_SCALE(1.5)},
   {5, RATE_LORA_25HZ,      -123, 29950, 6000, 4000, 600, 5000, SNR_SCALE(-3), SNR_SCALE(0.5)}};
#endif
