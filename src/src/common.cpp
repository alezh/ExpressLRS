...
// expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
//     {0, RADIO_TYPE_SX126x_LORA, RATE_LORA_500HZ,     SX126x_LORA_BW_0800, SX126x_LORA_SF5,  SX126x_LORA_CR_LI_4_6, TLM_RATIO_1_128, 4,  2000, 12, OTA4_PACKET_SIZE, 1},
//     {1, RADIO_TYPE_SX126x_LORA, RATE_LORA_333HZ_8CH, SX126x_LORA_BW_0800, SX126x_LORA_SF5,  SX126x_LORA_CR_LI_4_7, TLM_RATIO_1_128, 4,  3003, 12, OTA8_PACKET_SIZE, 1},
//     {2, RADIO_TYPE_SX126x_LORA, RATE_LORA_250HZ,     SX126x_LORA_BW_0800, SX126x_LORA_SF6,  SX126x_LORA_CR_LI_4_7, TLM_RATIO_1_64,  4,  4000, 14, OTA4_PACKET_SIZE, 1},
//     {3, RADIO_TYPE_SX126x_LORA, RATE_LORA_150HZ,     SX126x_LORA_BW_0800, SX126x_LORA_SF7,  SX126x_LORA_CR_LI_4_7, TLM_RATIO_1_32,  4,  6666, 12, OTA4_PACKET_SIZE, 1},
//     {4, RADIO_TYPE_SX126x_LORA, RATE_LORA_100HZ_8CH, SX126x_LORA_BW_0800, SX126x_LORA_SF7,  SX126x_LORA_CR_LI_4_7, TLM_RATIO_1_32,  4, 10000, 12, OTA8_PACKET_SIZE, 1},
//     {5, RADIO_TYPE_SX126x_LORA, RATE_LORA_50HZ,      SX126x_LORA_BW_0800, SX126x_LORA_SF8,  SX126x_LORA_CR_LI_4_7, TLM_RATIO_1_16,  2, 20000, 12, OTA4_PACKET_SIZE, 1},
//     {6, RADIO_TYPE_SX126x_LORA, RATE_LORA_25HZ,      SX126x_LORA_BW_0800, SX126x_LORA_SF9,  SX126x_LORA_CR_LI_4_7, TLM_RATIO_1_8,   2, 40000, 12, OTA8_PACKET_SIZE, 1},
//     {7, RADIO_TYPE_SX126x_LORA, RATE_LORA_4HZ,       SX126x_LORA_BW_0800, SX126x_LORA_SF12, SX126x_LORA_CR_LI_4_7, TLM_RATIO_1_4,   2,250000, 12, OTA8_PACKET_SIZE, 1}};

// expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
//     {0, RATE_LORA_500HZ,     -105,  1507, 2500, 2500,  3, 5000, SNR_SCALE( 5), SNR_SCALE(9.5)},
//     {1, RATE_LORA_333HZ_8CH, -105,  2374, 2500, 2500,  4, 5000, SNR_SCALE( 5), SNR_SCALE(9.5)},
//     {2, RATE_LORA_250HZ,     -108,  3300, 3000, 2500,  6, 5000, SNR_SCALE( 3), SNR_SCALE(9.5)},
//     {3, RATE_LORA_150HZ,     -112,  5871, 3500, 2500, 10, 5000, SNR_SCALE( 0), SNR_SCALE(8.5)},
...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
   {0, RADIO_TYPE_SX126x_LORA, RATE_LORA_250HZ,     SX126x_LORA_BW_500, SX126x_LORA_SF5, SX126x_LORA_CR_4_8, TLM_RATIO_1_64, 4,  4000,  8, OTA4_PACKET_SIZE, 1},
   {1, RADIO_TYPE_SX126x_LORA, RATE_LORA_100HZ_8CH, SX126x_LORA_BW_500, SX126x_LORA_SF6, SX126x_LORA_CR_4_8, TLM_RATIO_1_32, 4, 10000,  8, OTA8_PACKET_SIZE, 1},
   {2, RADIO_TYPE_SX126x_LORA, RATE_LORA_100HZ,     SX126x_LORA_BW_500, SX126x_LORA_SF7, SX126x_LORA_CR_4_7, TLM_RATIO_1_32, 4, 10000,  8, OTA4_PACKET_SIZE, 1},
   {3, RADIO_TYPE_SX126x_LORA, RATE_LORA_50HZ,      SX126x_LORA_BW_500, SX126x_LORA_SF8, SX126x_LORA_CR_4_7, TLM_RATIO_1_16, 4, 20000, 10, OTA4_PACKET_SIZE, 1},
   {4, RADIO_TYPE_SX126x_LORA, RATE_LORA_25HZ,      SX126x_LORA_BW_500, SX126x_LORA_SF9, SX126x_LORA_CR_4_7, TLM_RATIO_1_8,  2, 40000, 10, OTA4_PACKET_SIZE, 1},
   {5, RADIO_TYPE_SX126x_LORA, RATE_LORA_333HZ_8CH, SX126x_LORA_BW_500, SX126x_LORA_SF5, SX126x_LORA_CR_4_5, TLM_RATIO_1_64, 4,  3003,  8, OTA4_PACKET_SIZE, 1},
   {6, RADIO_TYPE_SX126x_LORA, RATE_LORA_150HZ,     SX126x_LORA_BW_500, SX126x_LORA_SF5, SX126x_LORA_CR_4_5, TLM_RATIO_1_64, 2,  3333, 12, OTA4_PACKET_SIZE, 2},
   {7, RADIO_TYPE_SX126x_LORA, RATE_LORA_50HZ,      SX126x_LORA_BW_500, SX126x_LORA_SF5, SX126x_LORA_CR_4_8, TLM_RATIO_1_64, 2,  5000, 12, OTA4_PACKET_SIZE, 4}};
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
   {0, RATE_LORA_250HZ,     -111,  3216, 3000, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)}, // TODO - SNR thresholds need to be checked.
   {1, RATE_LORA_100HZ_8CH, -112,  6690, 3500, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)},
   {2, RATE_LORA_100HZ,     -117,  8770, 3500, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(2.5)},
   {3, RATE_LORA_50HZ,      -120, 18560, 4000, 2500, 600, 5000, SNR_SCALE(-1), SNR_SCALE(1.5)},
   {4, RATE_LORA_25HZ,      -123, 29950, 6000, 4000,   0, 5000, SNR_SCALE(-3), SNR_SCALE(0.5)},
   {5, RATE_LORA_333HZ_8CH, -111,  2640, 2500, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)},
   {6, RATE_LORA_150HZ,     -111,  2640, 2500, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)},
   {7, RATE_LORA_50HZ,      -111,  2640, 2500, 2500, 600, 5000, SNR_SCALE( 1), SNR_SCALE(3.0)}};
#endif
